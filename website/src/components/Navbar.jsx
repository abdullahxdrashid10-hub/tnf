    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center w-full">
        ...
        <div className="flex lg:hidden items-center gap-4">
          <div onClick={() => navigate('/checkout')} className="text-[#FAF7F2]/80 relative p-1 cursor-pointer">
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.a 
              ...
              href="#contact" 
              onClick={handleQuote}
              className="block text-center mt-4 px-4 py-2.5 bg-[#B87333] text-[#1A1A1A] text-[10px] font-bold tracking-widest uppercase rounded-sm font-semibold"
            >
              Get A Quote
            </motion.a>
          </motion.div>
